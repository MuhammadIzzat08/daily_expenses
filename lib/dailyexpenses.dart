  ...
  void _addExpense() async{
    ...
    if (description.isNotEmpty && amount.isNotEmpty) {
      ...
      setState(() {
        ...
        calculateTotal();
        //totalSpend += expenseAmount; // Update the total spending.
      });
      } else{
...
// Select date and time
 ...
 /* //Navigate to edit screen
  ...
  totalAmount -= expenses[index].amount;
    setState(() {
      //final double removedAmount = double.parse(expenses[index].amount);
      expenses.removeAt(index);
      totalAmountController.text = totalAmount.toString();
      //totalSpend -= removedAmount; // Update the total spending.
    });
  }*/
      ...
      body: Column(
        children: [
         ...
         /* Padding(
            ...
            child: Text(
              'Total Spend: RM ${totalAmount.toStringAsFixed(2)}', // Display total spending.
